...
task7 = BashOperator(task_id='tsk7', bash_command="sleep 5", dag=dag, task_group=tskgroup)
task8 = BashOperator(task_id='tsk8', bash_command="sleep 5", dag=dag, task_group=tskgroup)
task9 = BashOperator(task_id='tsk9', bash_command="sleep 5", dag=dag, task_group=tskgroup, trigger_rule='one_failed')
